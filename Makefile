...
#	INC => q[-I/home/eric/proj/local/include]
#	LIBS => [q[-lm -L/home/eric/proj/local/lib -lical]]
#	MAKEFILE => q[Makefile]
#	NAME => q[ICal]
...
#
EXTRALIBS = -lm -L/home/eric/proj/local/lib -lical
LDLOADLIBS = -lm -L/home/eric/proj/local/lib -lical
BSLOADLIBS = 
LD_RUN_PATH = /lib:/home/eric/proj/local/lib
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"ICal\" VERSION=\"0,01,0,0\">\n}. qq{\t<TITLE>ICal</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > ICal.ppd
